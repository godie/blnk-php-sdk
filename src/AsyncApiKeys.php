...
class AsyncApiKeys
{
     ...
     * @return PromiseInterface The created API key (includes the full key value).
     */
     ...
     *
     * @param  string $owner Owner identifier.
     * @return PromiseInterface Array of API key objects.
     */
     ...
     * @return PromiseInterface Empty on success (204 No Content).
     */
